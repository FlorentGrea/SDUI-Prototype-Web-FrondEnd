...
export default function Sdui({mapPoints}: SduiProps) {
    return(  
        <main className="w-full h-screen">
            ...
            <Container className='absolute bottom-0 left-0 flex flex-col w-[100vw] h-[100vh] justify-between items-center pointer-events-none'>
                <Container className='mt-2 w-[400px] h-fit p-1 flex flex-col rounded-full pointer-events-auto bg-white'>
